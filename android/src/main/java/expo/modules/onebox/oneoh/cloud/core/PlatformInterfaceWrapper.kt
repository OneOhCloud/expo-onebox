...
import expo.modules.onebox.oneoh.cloud.ExpoOneBoxModule.Companion.packageManager
import expo.modules.onebox.oneoh.cloud.ExpoOneBoxModule.Companion.wifiManager
...
/**
 * PlatformInterface 桥接接口。
 * VPNService 实现此接口，提供 TUN 打开、网络监控、DNS 解析等平台能力给 libbox 核心。
 */
